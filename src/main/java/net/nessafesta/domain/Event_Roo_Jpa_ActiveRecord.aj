...
privileged aspect Event_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Event.fieldNames4OrderClauseFilter = java.util.Arrays.asList("id", "name", "partyDate", "partySize", "type", "invitations");
    ...
    public static Event Event.findEvent(String id) {
